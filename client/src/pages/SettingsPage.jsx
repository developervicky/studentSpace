...
export default function SettingsPage() {
  ...
  return (
    <>
      <div className="relative my-10 flex grow flex-col  rounded-lg border-2  border-primary2 p-5 text-white">
        ...
        <div className="absolute bottom-5 flex justify-between  gap-5">
